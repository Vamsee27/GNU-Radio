...
# Author: vamseekrishnatunuguntla
...
class Test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_threshold_ff_0_0 = blocks.threshold_ff((-samp_rate/2), (samp_rate/2), 0)
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-samp_rate/2), (samp_rate/2), 0)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 100000000, 0.5, 0, 0)
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_threshold_ff_0.set_hi((self.samp_rate/2))
        self.blocks_threshold_ff_0.set_lo((-self.samp_rate/2))
        self.blocks_threshold_ff_0_0.set_hi((self.samp_rate/2))
        self.blocks_threshold_ff_0_0.set_lo((-self.samp_rate/2))
