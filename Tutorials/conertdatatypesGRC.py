...
class conertdatatypesGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "conertdatatypesGRC")
...
def main(top_block_cls=conertdatatypesGRC, options=None):
